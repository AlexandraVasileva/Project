...
public class NewMark  extends JFrame{
	...
	public NewMark(){
		frame = new JFrame("Новая закладка");
	...
	private Container createContentPane() {
        ...
        JLabel newLabel = new JLabel("Закладка:");
        setLabelLF(newLabel);
        
        JTextField newMark = new JTextField("", 20);
        setFieldLF(newMark);
        
        JButton ok = new JButton("OK");
        setLabelLF(ok);
        ok.addActionListener(new actionListeners.NewMarkOkEventListener(this));
        			 ...
        			 .addGroup(layout.createSequentialGroup()
        				.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                			...
                			.addComponent(ok))
               				...
               				.addComponent(newMark)));

         
         layout.linkSize(SwingConstants.VERTICAL,
          		  new java.awt.Component[]{newLabel, newMark, ok});
